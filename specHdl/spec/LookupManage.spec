...
function LookupManage(PI, PR, glPktHdr) {
    ...
    if (PI.l3Type == PROTO_TYPE_IPV4) {
        ...
        bufHostRouteKey[135:0] = {8'h0, 32'h0, 32'h0, 32'h0, tmpIpDaW0};
        ...
        bufHostRouteKey[135:0] = {8'h1, tmpIpDaW3[31:0], tmpIpDaW2[31:0], tmpIpDaW1[31:0], tmpIpDaW0[31:0]};
    }

    /** 1 destination MAC lookup */
    if (CtlLkupCfg.macDaKeyEn) {
        bufMacKey[47:0]    = {tmpMacDaHi, tmpMacDa[31:0]};
        tmpCuMacHashL[3:0] = nextCRC8_D64(bufMacKey, sizeof(bufMacKey)) & setAllBitOne(calc( 32
));
        tmpCuMacHashR[4:0] = 16 + nextCRC16_D64(bufMacKey, sizeof(bufMacKey)) & setAllBitOne(calc( 32
));
    ...
    if (CtlLkupCfg.macPcpKeyEn) {
        bufMacPcpKey[55:0] = {tmpPcp, tmpMacDaHi[15:0], tmpMacDa[31:0]};
        tmpCuMacPcpHashL[3:0] = nextCRC8_D64(bufMacPcpKey, sizeof(bufMacPcpKey)) & setAllBitOne(calc( 32
));
        tmpCuMacPcpHashR[4:0] = 16 + nextCRC16_D64(bufMacPcpKey, sizeof(bufMacPcpKey)) & setAllBitOne(calc( 32
));
    ...
    if (CtlLkupCfg.ipDscpKeyEn) {
        bufIpDscpKey[135:0] = {tmpDscp, tmpIpDaW3[31:0], tmpIpDaW2[31:0], tmpIpDaW1[31:0], tmpIpDaW0[31:0]};
        tmpCuIpDscpHashL[calc( 16
)-1:0] = nextCRC8_D64(bufIpDscpKey, sizeof(bufIpDscpKey)) & setAllBitOne(calc( 16
));
        tmpCuIpDscpHashR[calc( 16
):0] = 8 + nextCRC16_D64(bufIpDscpKey, sizeof(bufIpDscpKey)) & setAllBitOne(calc( 16
));
    ...
    if (CtlLkupCfg.ipSportKeyEn) {
        bufIpSportKey[135:0] = {tmpL4SrcPort, tmpL3Next[7:0], tmpIpDaW3[31:0], tmpIpDaW2[31:0], tmpIpDaW1[31:0], tmpIpDaW0[31:0]};
        tmpCuIpSportHashL[calc( 16)-1:0] = nextCRC8_D64(bufIpSportKey, sizeof(bufIpSportKey)) & setAllBitOne(calc( 16));
        tmpCuIpSportHashR[calc( 16):0] = 8 + nextCRC16_D64(bufIpSportKey, sizeof(bufIpSportKey)) & setAllBitOne(calc( 16));
    ...
    if (CtlLkupCfg.ipDportKeyEn) {
        bufIpDportKey[135:0] = {tmpL4DestPort, tmpL3Next[7:0], tmpIpDaW3[31:0], tmpIpDaW2[31:0], tmpIpDaW1[31:0], tmpIpDaW0[31:0]};
        tmpCuIpDportHashL[calc( 16
)-1:0] = nextCRC8_D64(bufIpDportKey, sizeof(bufIpDportKey)) & setAllBitOne(calc( 16
));
        tmpCuIpDportHashR[calc( 16
):0] = 8 + nextCRC16_D64(bufIpDportKey, sizeof(bufIpDportKey)) & setAllBitOne(calc( 16
));
    ...
    if (PI.routingEn ) {
        ...
        tmpRouteHashLeft[2:0]= nextCRC8_D136( bufHostRouteKey, sizeof(bufHostRouteKey) ) & 3'h7;  
        tmpHostIdxL[5:0]= (tmpRouteHashLeft << 2);
        DsMemHostRouteLeftKeyVal    = DsMemHostRouteKey[ tmpRouteHashLeft ];
        // Right Hash
        // crc, 16'hfffff
        tmpRouteHashRight[3:0] = 8 + (nextCRC16_D136( bufHostRouteKey, sizeof(bufHostRouteKey) ) & 3'h7);   
        ...
        if (PI.l3Type == PROTO_TYPE_IPV6 ) {
            ...
            && (tmpIpDaW0[31:0] == DsMemHostRouteLeftKeyVal.ipAddrF1) ) {
                PI.hostRouteLeftHit  = 1;
            ...
            && (tmpIpDaW0[31:0] == DsMemHostRouteRightKeyVal.ipAddrF1) ) {
                PI.hostRouteRightHit = 1;
            ...
            && (tmpIpDaW0[31:0] == DsMemHostRouteLeftKeyVal.ipAddrF2) ) {
                PI.hostRouteLeftHit  = 1;
            ...
            && (tmpIpDaW0[31:0] == DsMemHostRouteRightKeyVal.ipAddrF2) ) {
                PI.hostRouteRightHit = 1;
            ...
            && (tmpIpDaW0[31:0] == DsMemHostRouteLeftKeyVal.ipAddrF3) ) {
                PI.hostRouteLeftHit  = 1;
            ...
            && (tmpIpDaW0[31:0] == DsMemHostRouteRightKeyVal.ipAddrF3) ) {
                PI.hostRouteRightHit = 1;
        ...
        /** Bridge Lookup */
        bufFdbkey[79:0] = {PI.fid, tmpMacDaHi[15:0], tmpMacDa[31:0]};
        tmpMacHashLeft[5:0] = nextCRC8_D64( bufFdbkey, sizeof(bufFdbkey)) & 5'h1f;    // Initial value is ffffffff 
        tmpMacHashRight[6:0] = (nextCRC16_D64( bufFdbkey, sizeof(bufFdbkey)) & 5'h1f) + 32;   // Initial value  is ffff 
        PI.macDaLValid    = 0;
        PI.macDaRValid   = 0;
        ...
        // Left check
        if (DsMemMacValidLeftVal.valid[tmpIdxLeft[4:0] : tmpIdxLeft[4:0]] && (DsMemMacKeyLeftVal.macAddr0 == tmpMacDa)
        ...
        if (DsMemMacValidRightVal.valid[tmpIdxRight[4:0] : tmpIdxRight[4:0]] && (DsMemMacKeyRightVal.macAddr0 == tmpMacDa)
        ...
        // Left check
        if (DsMemMacValidLeftVal.valid[tmpIdxLeft[4:0] : tmpIdxLeft[4:0]] && (DsMemMacKeyLeftVal.macAddr1 == tmpMacDa)
        ...
        if (DsMemMacValidRightVal.valid[tmpIdxRight[4:0] : tmpIdxRight[4:0]] && (DsMemMacKeyRightVal.macAddr1 == tmpMacDa)
