...
function HeaderAdjust( PI, glPktHdr, pktLength[13:0], channelId[0:0], hwDiscard[0:0] ) {
    ...
    PI.hasInnerHdr   = ((PI.srcPort == CtlCommon.cpuPortNo[0:0]) && CtlCommon.cpuHdrEn[0:0]);
    ...
    CtlHdrAdjLog.isTsn[0:0]     = PI.isTsn;
    CtlHdrAdjLog.discard[0:0]     = PI.discard;
    CtlHdrAdjLog.srcPort[0:0]     = PI.srcPort;
    //CtlHdrAdjLog.pktLenLog[0:0]     = PI.pktLenLog;
}
