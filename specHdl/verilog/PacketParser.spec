...
function PacketParser( PI, PR, glPktHdr ) {
    if (PI.pktType == PROTO_TYPE_ETH) {
        ...
        if( !tmpL2HdrError && (tmpTypeOrLen >= CtlParserEthernet.maxLength[0:0]) ) {
            // Ethernet II encapsulation
        } else if(!tmpL2HdrError && (tmpSap == 16'hAAAA) && (tmpSapCtl == 8'h03) && 
                  (CtlParserEthernet.allowNoneZeroOui[0:0] || (tmpSnapOui == 0) ) ) {
            PI.l3Offset   += 6;                // SAP + SAPCTL + OUI
            tmpQualifier[6:6] = 1;
        } else if(!tmpL2HdrError && (PI.l3Offset+4+CtlParserEthernet.ethSapCtlLen[0:0]) <= PI.hdrLength) {
            tmpQualifier[7:7] = 1;
        } else {
            PI.discard         = 1;
            PI.discardBmp[2:2] = 1;
        ...
        PI.jumboNum += (!tmpL2HdrError && PI.pktLength > CtlParserEthernet.maxLength[0:0]) ? 1:0;
        ...
        if (PI.pktType == PROTO_TYPE_INVALID) {
            ...
            if (CtlL2HdrProtoCam.valid[0:0] && (CtlL2HdrProtoCam.l2ProtoData0[15:0] & CtlL2HdrProtoCam.l2ProtoMask0[15:0]) == (tmpTypeOrLen & CtlL2HdrProtoCam.l2ProtoMask0)) 
                PI.pktType = CtlL2HdrProtoCam.l3Type0[0:0];
            ...
            if (CtlL2HdrProtoCam.valid[1:1] && (CtlL2HdrProtoCam.l2ProtoData1[15:0] & CtlL2HdrProtoCam.l2ProtoMask1[15:0]) == (tmpTypeOrLen & CtlL2HdrProtoCam.l2ProtoMask1)) 
                PI.pktType = CtlL2HdrProtoCam.l3Type1[0:0];
            ...
            if (CtlL2HdrProtoCam.valid[2:2] && (CtlL2HdrProtoCam.l2ProtoData2[15:0] & CtlL2HdrProtoCam.l2ProtoMask2[15:0]) == (tmpTypeOrLen & CtlL2HdrProtoCam.l2ProtoMask2)) 
                PI.pktType = CtlL2HdrProtoCam.l3Type2[0:0];
            ...
            if (CtlL2HdrProtoCam.valid[3:3] && (CtlL2HdrProtoCam.l2ProtoData3[15:0] & CtlL2HdrProtoCam.l2ProtoMask3[15:0]) == (tmpTypeOrLen & CtlL2HdrProtoCam.l2ProtoMask3)) 
                PI.pktType = CtlL2HdrProtoCam.l3Type3[0:0];
            ...
            if (CtlL2HdrProtoCam.valid[4:4] && (CtlL2HdrProtoCam.l2ProtoData4[15:0] & CtlL2HdrProtoCam.l2ProtoMask4[15:0]) == (tmpTypeOrLen & CtlL2HdrProtoCam.l2ProtoMask4)) 
                PI.pktType = CtlL2HdrProtoCam.l3Type4[0:0];
            ...
            if (CtlL2HdrProtoCam.valid[5:5] && (CtlL2HdrProtoCam.l2ProtoData5[15:0] & CtlL2HdrProtoCam.l2ProtoMask5[15:0]) == (tmpTypeOrLen & CtlL2HdrProtoCam.l2ProtoMask5)) 
                PI.pktType = CtlL2HdrProtoCam.l3Type5[0:0];
            ...
            if (CtlL2HdrProtoCam.valid[6:6] && (CtlL2HdrProtoCam.l2ProtoData6[15:0] & CtlL2HdrProtoCam.l2ProtoMask6[15:0]) == (tmpTypeOrLen & CtlL2HdrProtoCam.l2ProtoMask6)) 
                PI.pktType = CtlL2HdrProtoCam.l3Type6[0:0];
            ...
            if (CtlL2HdrProtoCam.valid[7:7] && (CtlL2HdrProtoCam.l2ProtoData7[15:0] & CtlL2HdrProtoCam.l2ProtoMask7[15:0]) == (tmpTypeOrLen & CtlL2HdrProtoCam.l2ProtoMask7)) 
                PI.pktType = CtlL2HdrProtoCam.l3Type7[0:0];
    ...
    if (PI.pktType > PROTO_TYPE_ETH && PI.pktType < PROTO_TYPE_UDP) {
        ...
        if (PI.l4Type == PROTO_TYPE_INVALID) { 
            ...
            if (CtlL3HdrProtoCam.isValid[0:0] && ((PI.l3Type & CtlL3HdrProtoCam.l3TypeMask0) == 
             (CtlL3HdrProtoCam.l3TypeData0[0:0] & CtlL3HdrProtoCam.l3TypeMask0[0:0])) && 
               ((tmpL3NextProto & CtlL3HdrProtoCam.l3ProtoMask0[0:0]) == 
                 (CtlL3HdrProtoCam.l3ProtoData0[0:0] & CtlL3HdrProtoCam.l3ProtoMask0[0:0]))) {
                PI.pktType     = CtlL3HdrProtoCam.l4Type0[0:0];
                tmpPr.protocol = CtlL3HdrProtoCam.protocol[0:0];
            }
    
            if (CtlL3HdrProtoCam.isValid[1:1] && ((PI.l3Type & CtlL3HdrProtoCam.l3TypeMask1) == 
             (CtlL3HdrProtoCam.l3TypeData1[0:0] & CtlL3HdrProtoCam.l3TypeMask1[0:0])) && 
               ((tmpL3NextProto & CtlL3HdrProtoCam.l3ProtoMask1[0:0]) == 
                 (CtlL3HdrProtoCam.l3ProtoData1[0:0] & CtlL3HdrProtoCam.l3ProtoMask1[0:0]))) {
                PI.pktType     = CtlL3HdrProtoCam.l4Type1[0:0];
                tmpPr.protocol = CtlL3HdrProtoCam.protocol[0:0];
            }
    
            if (CtlL3HdrProtoCam.isValid[2:2] && ((PI.l3Type & CtlL3HdrProtoCam.l3TypeMask2) == 
             (CtlL3HdrProtoCam.l3TypeData2[0:0] & CtlL3HdrProtoCam.l3TypeMask2[0:0])) && 
               ((tmpL3NextProto & CtlL3HdrProtoCam.l3ProtoMask2[0:0]) == 
                 (CtlL3HdrProtoCam.l3ProtoData2[0:0] & CtlL3HdrProtoCam.l3ProtoMask2[0:0]))) {
                PI.pktType     = CtlL3HdrProtoCam.l4Type2[0:0];
                tmpPr.protocol = CtlL3HdrProtoCam.protocol[0:0];
            }
    
            if (CtlL3HdrProtoCam.isValid[3:3] && ((PI.l3Type & CtlL3HdrProtoCam.l3TypeMask3) == 
             (CtlL3HdrProtoCam.l3TypeData3[0:0] & CtlL3HdrProtoCam.l3TypeMask3[0:0])) && 
               ((tmpL3NextProto & CtlL3HdrProtoCam.l3ProtoMask3[0:0]) == 
                 (CtlL3HdrProtoCam.l3ProtoData3[0:0] & CtlL3HdrProtoCam.l3ProtoMask3[0:0]))) {
                PI.pktType     = CtlL3HdrProtoCam.l4Type3[0:0];
                tmpPr.protocol = CtlL3HdrProtoCam.protocol[0:0];
            }

            if (CtlL3HdrProtoCam.isValid[4:4] && ((PI.l3Type & CtlL3HdrProtoCam.l3TypeMask4) == 
             (CtlL3HdrProtoCam.l3TypeData4[0:0] & CtlL3HdrProtoCam.l3TypeMask4[0:0])) && 
               ((tmpL3NextProto & CtlL3HdrProtoCam.l3ProtoMask4[0:0]) == 
                 (CtlL3HdrProtoCam.l3ProtoData4[0:0] & CtlL3HdrProtoCam.l3ProtoMask4[0:0]))) {
                PI.pktType     = CtlL3HdrProtoCam.l4Type4[0:0];
                tmpPr.protocol = CtlL3HdrProtoCam.protocol[0:0];
            }
    
            if (CtlL3HdrProtoCam.isValid[5:5] && ((PI.l3Type & CtlL3HdrProtoCam.l3TypeMask5) == 
             (CtlL3HdrProtoCam.l3TypeData5[0:0] & CtlL3HdrProtoCam.l3TypeMask5[0:0])) && 
               ((tmpL3NextProto & CtlL3HdrProtoCam.l3ProtoMask5[0:0]) == 
                 (CtlL3HdrProtoCam.l3ProtoData5[0:0] & CtlL3HdrProtoCam.l3ProtoMask5[0:0]))) {
                PI.pktType     = CtlL3HdrProtoCam.l4Type5[0:0];
                tmpPr.protocol = CtlL3HdrProtoCam.protocol[0:0];
            }
    
            if (CtlL3HdrProtoCam.isValid[6:6] && ((PI.l3Type & CtlL3HdrProtoCam.l3TypeMask6) == 
             (CtlL3HdrProtoCam.l3TypeData6[0:0] & CtlL3HdrProtoCam.l3TypeMask6[0:0])) && 
               ((tmpL3NextProto & CtlL3HdrProtoCam.l3ProtoMask6[0:0]) == 
                 (CtlL3HdrProtoCam.l3ProtoData6[0:0] & CtlL3HdrProtoCam.l3ProtoMask6[0:0]))) {
                PI.pktType     = CtlL3HdrProtoCam.l4Type6[0:0];
                tmpPr.protocol = CtlL3HdrProtoCam.protocol[0:0];
            }
    
            if (CtlL3HdrProtoCam.isValid[7:7] && ((PI.l3Type & CtlL3HdrProtoCam.l3TypeMask7) == 
             (CtlL3HdrProtoCam.l3TypeData7[0:0] & CtlL3HdrProtoCam.l3TypeMask7[0:0])) && 
               ((tmpL3NextProto & CtlL3HdrProtoCam.l3ProtoMask7[0:0]) == 
                 (CtlL3HdrProtoCam.l3ProtoData7[0:0] & CtlL3HdrProtoCam.l3ProtoMask7[0:0]))) {
                PI.pktType     = CtlL3HdrProtoCam.l4Type7[0:0];
                tmpPr.protocol = CtlL3HdrProtoCam.protocol[0:0];
            }
    
            if (CtlL3HdrProtoCam.isValid[8:8] && ((PI.l3Type & CtlL3HdrProtoCam.l3TypeMask8) == 
             (CtlL3HdrProtoCam.l3TypeData8[0:0] & CtlL3HdrProtoCam.l3TypeMask8[0:0])) && 
               ((tmpL3NextProto & CtlL3HdrProtoCam.l3ProtoMask8[0:0]) == 
                 (CtlL3HdrProtoCam.l3ProtoData8[0:0] & CtlL3HdrProtoCam.l3ProtoMask8[0:0]))) {
                PI.pktType     = CtlL3HdrProtoCam.l4Type8[0:0];
                tmpPr.protocol = CtlL3HdrProtoCam.protocol[0:0];
            }
    
            if (CtlL3HdrProtoCam.isValid[9:9] && ((PI.l3Type & CtlL3HdrProtoCam.l3TypeMask9) == 
             (CtlL3HdrProtoCam.l3TypeData9[0:0] & CtlL3HdrProtoCam.l3TypeMask9[0:0])) && 
               ((tmpL3NextProto & CtlL3HdrProtoCam.l3ProtoMask9[0:0]) == 
                 (CtlL3HdrProtoCam.l3ProtoData9[0:0] & CtlL3HdrProtoCam.l3ProtoMask9[0:0]))) {
                PI.pktType     = CtlL3HdrProtoCam.l4Type9[0:0];
                tmpPr.protocol = CtlL3HdrProtoCam.protocol[0:0];
            }
    
            if (CtlL3HdrProtoCam.isValid[10:10] && ((PI.l3Type & CtlL3HdrProtoCam.l3TypeMask10) == 
             (CtlL3HdrProtoCam.l3TypeData10[0:0] & CtlL3HdrProtoCam.l3TypeMask10[0:0])) && 
               ((tmpL3NextProto & CtlL3HdrProtoCam.l3ProtoMask10[0:0]) == 
                 (CtlL3HdrProtoCam.l3ProtoData10[0:0] & CtlL3HdrProtoCam.l3ProtoMask10[0:0]))) {
                PI.pktType     = CtlL3HdrProtoCam.l4Type10[0:0];
                tmpPr.protocol = CtlL3HdrProtoCam.protocol[0:0];
            }
    
            if (CtlL3HdrProtoCam.isValid[11:11] && ((PI.l3Type & CtlL3HdrProtoCam.l3TypeMask11) == 
             (CtlL3HdrProtoCam.l3TypeData11[0:0] & CtlL3HdrProtoCam.l3TypeMask11[0:0])) && 
               ((tmpL3NextProto & CtlL3HdrProtoCam.l3ProtoMask11[0:0]) == 
                 (CtlL3HdrProtoCam.l3ProtoData11[0:0] & CtlL3HdrProtoCam.l3ProtoMask11[0:0]))) {
                PI.pktType     = CtlL3HdrProtoCam.l4Type11[0:0];
                tmpPr.protocol = CtlL3HdrProtoCam.protocol[0:0];
            }
    
            if (CtlL3HdrProtoCam.isValid[12:12] && ((PI.l3Type & CtlL3HdrProtoCam.l3TypeMask12) == 
             (CtlL3HdrProtoCam.l3TypeData12[0:0] & CtlL3HdrProtoCam.l3TypeMask12[0:0])) && 
               ((tmpL3NextProto & CtlL3HdrProtoCam.l3ProtoMask12[0:0]) == 
                 (CtlL3HdrProtoCam.l3ProtoData12[0:0] & CtlL3HdrProtoCam.l3ProtoMask12[0:0]))) {
                PI.pktType     = CtlL3HdrProtoCam.l4Type12[0:0];
                tmpPr.protocol = CtlL3HdrProtoCam.protocol[0:0];
            }
    
            if (CtlL3HdrProtoCam.isValid[13:13] && ((PI.l3Type & CtlL3HdrProtoCam.l3TypeMask13) == 
             (CtlL3HdrProtoCam.l3TypeData13[0:0] & CtlL3HdrProtoCam.l3TypeMask13[0:0])) && 
               ((tmpL3NextProto & CtlL3HdrProtoCam.l3ProtoMask13[0:0]) == 
                 (CtlL3HdrProtoCam.l3ProtoData13[0:0] & CtlL3HdrProtoCam.l3ProtoMask13[0:0]))) {
                PI.pktType     = CtlL3HdrProtoCam.l4Type13[0:0];
                tmpPr.protocol = CtlL3HdrProtoCam.protocol[0:0];
            }
    
            if (CtlL3HdrProtoCam.isValid[14:14] && ((PI.l3Type & CtlL3HdrProtoCam.l3TypeMask14) == 
             (CtlL3HdrProtoCam.l3TypeData14[0:0] & CtlL3HdrProtoCam.l3TypeMask14[0:0])) && 
               ((tmpL3NextProto & CtlL3HdrProtoCam.l3ProtoMask14[0:0]) == 
                 (CtlL3HdrProtoCam.l3ProtoData14[0:0] & CtlL3HdrProtoCam.l3ProtoMask14[0:0]))) {
                PI.pktType     = CtlL3HdrProtoCam.l4Type14[0:0];
                tmpPr.protocol = CtlL3HdrProtoCam.protocol[0:0];
            }
    
            if (CtlL3HdrProtoCam.isValid[15:15] && ((PI.l3Type & CtlL3HdrProtoCam.l3TypeMask15) == 
             (CtlL3HdrProtoCam.l3TypeData15[0:0] & CtlL3HdrProtoCam.l3TypeMask15[0:0])) && 
               ((tmpL3NextProto & CtlL3HdrProtoCam.l3ProtoMask15[0:0]) == 
                 (CtlL3HdrProtoCam.l3ProtoData15[0:0] & CtlL3HdrProtoCam.l3ProtoMask15[0:0]))) {
                PI.pktType     = CtlL3HdrProtoCam.l4Type15[0:0];
                tmpPr.protocol = CtlL3HdrProtoCam.protocol[0:0];
            }
    ...
    if (PI.pktType >= PROTO_TYPE_UDP) {
        ...
        if ((PI.l4Type == PROTO_TYPE_UDP) && (tmpL4DestPort == CtlParserL4Port.ptpPort0[0:0] || tmpL4DestPort == CtlParserL4Port.ptpPort1[0:0])) {   // PTP
        ...
        } else if ((PI.l4Type == PROTO_TYPE_UDP) && (tmpL4DestPort == CtlParserL4Port.bfdPort0[0:0] || tmpL4DestPort == CtlParserL4Port.bfdPort1[0:0])) {  // BFD
        ...
        } else if ((PI.l4Type == PROTO_TYPE_UDP) && (tmpL4DestPort == CtlParserL4Port.bfdEcho[0:0])) {  // BFD Echo
            PI.isBfdEcho       = 1;
        }
    }
    
    tmpIsAvb = (PI.l4Type == PROTO_TYPE_UDP) && (tmpL4DestPort >= CtlParserL4Port.avbPortLo[0:0]) && (tmpL4DestPort <= CtlParserL4Port.avbPortHi[0:0]);
    ...
    if( (PI.l4Type == PROTO_TYPE_UDP) && ((tmpL4DestPort == CtlParserL4Port.snmpPort0[0:0])
                            ||(tmpL4DestPort == CtlParserL4Port.snmpPort1[0:0])) ) {
        PI.isSnmp      = 1;
        PI.snmpPkt     = 1;
    }
    ...
    PI.dosDropBmp    = 0;
    if (CtlDosControl.macSaEqMacDaDrop[0:0] && tmpMacAddrEq) {
        PI.discard         = PI.discard | 1;
        PI.dosDropBmp = 1;
    }
    ...
    if ( !tmpL3HdrError && CtlDosControl.sipEqDipDrop[0:0] && tmpIpSaEqDa ) {
        PI.discard         = PI.discard | 1;
        PI.dosDropBmp[2:2] = 1;
    }
    ...
    tmpV4PingSizeCheckFailed = CtlDosControl.icmpV4PingSizeCheck[0:0] && tmpIsV4PingPacket && 
                               (PI.pktLength > CtlDosControl.icmpV4MaxSize[0:0]);
    tmpV6PingSizeCheckFailed = CtlDosControl.icmpV6PingSizeCheck[0:0] && PI.l4Type == PROTO_TYPE_V6PING && 
                               (PI.pktLength > CtlDosControl.icmpV6MaxSize[0:0]);
    ...
    CtlPktParserLog.userData0[0:0]    = PI.userData0;
    CtlPktParserLog.userData1[0:0]    = PI.userData1;
    CtlPktParserLog.randomSeed[0:0]    = PI.randomSeed;
    CtlPktParserLog.dosDropBmp[0:0]    = PI.dosDropBmp;
    CtlPktParserLog.l2Type[0:0]    = PI.l2Type;
    CtlPktParserLog.stagValid[0:0]    = PI.stagValid;
    CtlPktParserLog.ctagValid[0:0]    = PI.ctagValid;
    CtlPktParserLog.rtagValid[0:0]    = PI.rtagValid;
    CtlPktParserLog.l3Type[0:0]    = PI.l3Type;
    CtlPktParserLog.l4Type[0:0]   = PI.l4Type;
    CtlPktParserLog.l2HdrError[0:0]    = PI.l2HdrError;
    CtlPktParserLog.l3HdrError[0:0]    = PI.l3HdrError;
    CtlPktParserLog.l4HdrError[0:0]    = PI.l4HdrError;
    CtlPktParserLog.rtcpPkt[0:0]    = PI.rtcpPkt;
    CtlPktParserLog.isPtp[0:0]    = PI.isPtp;
    CtlPktParserLog.rtpPkt[0:0]    = PI.rtpPkt;
    CtlPktParserLog.snmpPkt[0:0]    = PI.snmpPkt;
    CtlPktParserLog.isBfd[0:0]    = PI.isBfd;
    CtlPktParserLog.jumboNum[0:0]    = PI.jumboNum;
}
